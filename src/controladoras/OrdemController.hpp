...
private:
     ...
     * @param carteiraAtual Carteira atual
     */
    void exibirResumoOrdem(const Codigo& codigoOrdem, const CodigoNeg& codigoNegociacao,
     ...
     */
    bool solicitarCodigoExclusao(Codigo& codigoOrdem, const std::list<Ordem>& ordensCarteira,
