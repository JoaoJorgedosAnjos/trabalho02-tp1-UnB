...
/**
 * @class CodigoNeg
 * @brief Classe que representa uma sequencia unica de identificacao, com exatamente 12 caracteres alfanumericos ou
 * espacos.
 *
...
class CodigoNeg
{
  private:
    ...
    /**
     * @brief Metodo privado responsavel por validar se o valor fornecido atende o formato correto para o codigo de
     * negociacao.
     *
...
/**
 * @class Ncpf
 * @brief Classe que representa uma sequencia unica de identificacao, com exatamente 14 caracteres no formato
 * XXX.XXX.XXX-XX.
 *
 * Esta classe e utilizada para representar um CPF (Cadastro de Pessoa Fisica) no sistema de investimentos,
 * conforme as regras de formatacao estabelecidas pela Receita Federal do Brasil. O CPF pode estar associado, por
 ...
 *
 * A classe `Ncpf` e responsavel por armazenar e validar um numero de CPF, garantindo que o valor interno esteja em
 * conformidade com o formato e que os digitos verificadores sejam validos conforme regras oficiais.
 *
 * Regras de validacao:
...
class Ncpf
{
  private:
     ...
     * pontos e hifen nas posicoes corretas; se contem 11 digitos numericos validos; se possui digitos verificadores
...
/**
 * @class Data
 * @brief Classe que representa uma abstracao de tempo por meio de uma sequencia de 8 digitos numericos no formato
 * AAAAMMDD.
 *
 * Esta classe e utilizada para representar uma data relevante para operacoes no sistema de investimentos,
 * correspondendo ao calendario gregoriano,e composta por ano, mes e dia, conforme as regras de formatacao
 ...
 *
 * Regras de validacao:
 * - O valor deve ser um numero inteiro positivo simples (ex: "1000", "50000") ou formato brasileiro (ex: "1.000",
 * "50.000").
...
class Quantidade
{
  private:
     ...
     *
     * Regras de validacao:
     * - Deve ser um numero inteiro positivo simples (ex: "1000", "50000") ou formato brasileiro (ex: "1.000",
     * "50.000");
